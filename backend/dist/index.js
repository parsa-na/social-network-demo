...
app.post('/auth', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, rawPassword, hashed, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = req.body;
                rawPassword = req.body.password;
                return [4 /*yield*/, bcrypt_1["default"].hash(rawPassword, 12)];
            case 1:
                hashed = _a.sent();
                _a.label = 2;
            case 2:
            ...
            case 4:
                ...
                if ((err_1).code == 'P2002') {
                    return [2 /*return*/, res.status(401).send({ message: "this username already exists!!!" })];
                }
                return [3 /*break*/, 5];
            case 5:
                res.status(201).send({
